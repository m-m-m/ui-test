...
import io.github.mmm.ui.test.widget.link.TestInternalLink;
 ...
 * @since 1.0.0
 */
public class TestFactoryInternalLink implements UiSingleWidgetFactoryNative<UiInternalLink> {
