...
import io.github.mmm.ui.test.widget.input.TestPasswordInput;
 ...
 * @since 1.0.0
 */
public class TestFactoryPasswordInput implements UiSingleWidgetFactoryNative<UiPasswordInput> {
