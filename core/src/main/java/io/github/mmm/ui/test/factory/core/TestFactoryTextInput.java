...
import io.github.mmm.ui.test.widget.input.TestTextInput;
 ...
 * @since 1.0.0
 */
public class TestFactoryTextInput implements UiSingleWidgetFactoryNative<UiTextInput> {
