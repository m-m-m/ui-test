...
import io.github.mmm.ui.test.widget.chart.TestBarChartHorizontal;
 ...
 * @since 1.0.0
 */
public class TestFactoryBarChartHorizontal implements UiSingleWidgetFactoryNative<UiBarChartHorizontal> {
  ...
  public UiBarChartHorizontal create() {
    ...
    return new TestBarChartHorizontal();
  }
