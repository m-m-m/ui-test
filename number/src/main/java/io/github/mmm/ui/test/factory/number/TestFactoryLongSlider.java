...
import io.github.mmm.ui.test.widget.number.TestLongSlider;
 ...
 * @since 1.0.0
 */
public class TestFactoryLongSlider implements UiSingleWidgetFactoryNative<UiLongSlider> {
