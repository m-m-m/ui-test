...
import io.github.mmm.ui.test.widget.number.TestLongInput;
 ...
 * @since 1.0.0
 */
public class TestFactoryLongInput implements UiSingleWidgetFactoryNative<UiLongInput> {
